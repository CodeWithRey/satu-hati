...
@section('content')
    ...
    <section
        ...
        <div class="px-4 mx-auto max-w-screen-xl w-11/12 gap-8 text-center grid md:grid-cols-2 grid-cols-1 place-items-center h-full">
            <div class="mx-auto">
                <h1
                    class="py-1 mb-4 text-4xl font-extrabold tracking-tight leading-none text-[#CB6A10] md:text-5xl lg:text-6xl text-left">SatuHati</h1>
                <p class="mb-4 text-4xl font-bold text-black text-left">Apakah Anda ingin melakukan pengaduan?</p>

                <img src="{{ asset('assets/images/calling.png') }}" alt="icon-calling" class="max-h-[250px] mx-auto md:hidden block">
            ...
            <img src="{{ asset('assets/images/calling.png') }}" alt="icon-calling" class="max-h-[400px] mx-auto  md:block hidden">
        </div>
    </section>
    ...
    <section class="bg-center bg-no-repeat min-h-[100vh] bg-cover bg-white bg-blend-multiply relative">
        ...
        <div
            ...
            <div
                ...
                <img class="w-48 h-48 mb-4 object-contain mx-auto " src="{{ asset('assets/images/sapa-129.png') }}" alt="sapa-129">
                ...
                <p class="mb-3 font-normal text-black text-left">
                    Hubungi 129 untuk melakukan pengaduan. Call Center Sahabat Perempuan dan Anak 129 bertujuan mempermudah akses bagi korban dalam melakukan pengaduan kasus kekerasan seksual, serta pendataan kasusnya.
            </div>
        
            <div
                class="max-w-sm h-full p-6 bg-[#FFEAB3] border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <img class="w-48 h-48 mb-4 object-contain mx-auto " src="{{ asset('assets/images/komnas-perempuan.png') }}" alt="logo-komnas-perempuan">

                <h5 class="mb-2 text-xl font-semibold tracking-tight text-black dark:text-white">Komnas Perempuan</h5>

                <p class="mb-3 font-normal text-black text-left">
                    Pelapor bisa membuat laporan ke Komnas Perempuan dengan mengirim berkas ke email komnas perempuan Selain itu, bisa melapor langsung melalui media sosial resmi Komnas Perempuan.
            </div>

            <div
                class="max-w-sm h-full p-6 bg-[#FFEAB3] border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <img class="w-48 h-48 mb-4 object-contain mx-auto " src="{{ asset('assets/images/komnas-ham.png') }}" alt="logo-komnas-ham">

                <h5 class="mb-2 text-xl font-semibold tracking-tight text-black dark:text-white">Komnas HAM</h5>

                <p class="mb-3 font-normal text-black text-left">
                    Pelapor bisa mengirim berkasnya secara langsung ke alamat Komnas HAM. Pun dapat melalui aduan online, dengan mengisi berkas pada laman komnas ham. Komnas HAM juga menerima layanan konsultasi melalui nomor 08111129129.
            </div>

            <div
                class="max-w-sm p-6 h-full bg-[#FFEAB3] border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <img class="w-48 h-48 mb-4 object-contain mx-auto " src="{{ asset('assets/images/lpsk.png') }}" alt="logo-lpsk">

                <h5 class="mb-2 text-xl font-semibold tracking-tight text-black dark:text-white">Lembaga Perlindungan Saksi dan Korban (LPSK)</h5>
            ...
            <div
                class="max-w-sm h-full p-6 bg-[#FFEAB3] border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <img class="w-48 h-48 mb-4 object-contain mx-auto " src="{{ asset('assets/images/polri.png') }}" alt="logo-polri">
            ...
            <div
                ...
                <img class="w-48 h-48 mb-4 object-contain mx-auto" src="{{ asset('assets/images/logo-kemenpppa.png') }}" alt="logo-kemenpppa">

                <h5 class="mb-2 text-xl font-semibold tracking-tight text-black dark:text-white">Kementerian Pemberdayaan Perempuan dan Perlindungan Anak (KemenPPPA)</h5>
