...
@section('content')
        ...
        <div class=" px-4 mx-auto max-w-screen-xl text-center grid md:grid-cols-2 grid-cols-1 place-items-center h-full">
            <div class="">
                ...
                <div class="py-7 flex flex-col space-y-4 sm:flex-row sm:justify-left sm:space-y-0">
                    <a href="{{ route('forum') }}"
                        class="inline-flex font- gap-2 justify-center items-center py-3 px-5 text-base font-bold text-center text-white rounded-lg bg-orange-700 hover:bg-orange-600 focus:ring-4 focus:ring-orange-300 transition duration-300">
                        Forum Curhat<i class="fa-solid fa-comments"></i>
                    </a>
                    <a href="#"
                        class="inline-flex font- gap-2 justify-center hover:text-white hover:bg-orange-700 items-center py-3 px-5 sm:ms-4 text-base font-bold text-center text-orange-700 rounded-lg border-2 border-orange-700 focus:ring-4 focus:ring-orange-300 transition duration-300">
    ...
    <section>
        <div class="grid md:grid-cols-2 grid-cols-1 p-4 place-items-stretch">
            <div class="flex flex-col gap-6 p-16 place-content-center">
                <h2 class="md:text-start text-center text-3xl font-bold text-black place-content-center">Pelecehan Seksual
                    <span class="text-3xl font-bold text-orange-600">Secara Verbal</span></h2>
        ...
        <div class="grid md:grid-cols-2 grid-cols-1 p-4 place-items-stretch">
            ...
            <div class="flex flex-col gap-6 p-16 place-content-center">
                <h2 class="md:text-start text-center text-3xl font-bold text-black place-content-center">Pelecehan Seksual
                    <span class="text-3xl font-bold text-orange-600">Secara Fisik</span></h2>
        ...
        <div class="grid md:grid-cols-2 grid-cols-1 p-4 place-items-stretch">
            <div class="flex flex-col gap-6 p-16 place-content-center">
                <h2 class="md:text-start text-center text-3xl font-bold text-black place-content-center">Pelecehan Seksual
                    <span class="text-3xl font-bold text-orange-600">Secara Non Fisik</span></h2>
        ...
        <div class="grid md:grid-cols-2 grid-cols-1 p-4 place-items-stretch">
            ...
            <div class="flex flex-col gap-6 p-16 place-content-center">
                <h2 class="md:text-start text-center text-3xl font-bold text-black place-content-center">Pelecehan Seksual
                    <span class="text-3xl font-bold text-orange-600">Secara Daring</span></h2>
    ...
    <section class="bg-landing2 py-12">
        <div class="flex flex-col items-center justify-center h-full py-8">
            <h1 class="font-extrabold tracking-tight leading-none text-black text-3xl md:text-4xl text-left">Pemenuhan Hak
                Korban</h1>
            <h1 class="font-extrabold tracking-tight leading-none text-orange-600 text-3xl md:text-4xl text-left">Pelecehan
                Seksual</h1>
        </div>
