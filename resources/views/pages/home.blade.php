...
@section('content')
    ...
    <section>
        <div class="grid md:grid-cols-2 grid-cols-1 p-4 place-items-stretch">
            ...
            <img class="md:block hidden h-auto w-auto" src="{{ asset('assets/images/verbal.png') }}" alt="">
        </div>
        ...
        <div class="grid md:grid-cols-2 grid-cols-1 p-4 place-items-stretch">
            ...
            <img class="md:block hidden h-auto w-auto" src="{{ asset('assets/images/non-fisik.png') }}" alt="">
        </div>

        
        <div class="grid md:grid-cols-2 grid-cols-1 p-4 place-items-stretch">
            <img class="md:block hidden h-auto w-auto" src="{{ asset('assets/images/daring.png') }}" alt="">
            <div class="flex flex-col gap-6 p-16 place-content-center">
                <h2 class="text-start text-3xl font-bold text-black place-content-center">Pelecehan Seksual <span
