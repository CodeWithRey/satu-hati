        ...
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                <button type="button"
                    ...
                    <!-- Ganti URL dan sumber gambar sesuai kebutuhan -->
                    <img class="w-8 h-8 rounded-full" src="/path/to/user/profile-picture.jpg" alt="user photo">
                </button>
                <!-- Dropdown menu -->
                <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600"
                    ...
                    <div class="px-4 py-3">
                        ...
                        <span class="block text-sm  text-gray-500 truncate dark:text-gray-400">email@example.com</span>
                    </div>
