      ...
      <div class="md:flex md:justify-center">
        ...
        <div class="grid grid-cols-2 gap-7 sm:gap-6 sm:grid-cols-3 px-8">
            ...
            <div>
               ...
               <p class="flex items-center  text-gray-500 dark:text-gray-400 font-">Hubungi kami jika terdapat kendala saat menggunakan website satu hati.</p>
            </div>
        </div>
    </div>
    <hr class="my-6 border-gray-200 sm:mx-auto dark:border-gray-700 lg:my-8" />
    <div class="sm:flex sm:items-center sm:justify-between">
        <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" class="hover:underline">SatuHati™</a>. All Rights Reserved.
        </span>
